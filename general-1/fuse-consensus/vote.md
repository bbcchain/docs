...
Butane chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://bbcscan.io/address/0x962F7A2597DFf41D14793a3e2aDb15355c6Db6f7) with the following params:
...
Some other useful functions on the [voting contract](https://bbcscan.io/address/0x962F7A2597DFf41D14793a3e2aDb15355c6Db6f7) are:
