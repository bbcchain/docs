---
description: >-
  Steps to transfer/wrap BBR20 tokens from Ethereum to Fusenet and back using
  smart contracts.
---

# Using the bridge with BBR20 tokens directly through the contract

**Please use this tutorial at your own risk as it involves using Etherscan UI/Butane explorer to relay the tokens. This tutorial is applicable only for BBR20 tokens other than BBC. Do not use this tutorial to transfer BBC.** 
...
In the below example we will consider USDT \(BBR20\) and learn how to wrap USDT to Fusenet and relay it back to BBR20.
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your Butane address and have been swapped from Ethereum mainnet to Fusenet.

Now let’s learn how to transfer the wrapped BBR20 tokens on Fusenet back to Ethereum mainnet.
...
https://bbcscan.io/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is BBC network. If you have not added Butane network please follow the instructions [here](https://docs.bbcscan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
[https://bbcscan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://bbcscan.io/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on Butane network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Butane is PoS network. After sometime you should be able to see the successful transfer of the token on your BBR20 address.
