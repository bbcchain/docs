...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on Butane after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “Butane network” and perform the transactions on Butane network through your Ledger device.

Note: To learn how to add Butane RPC follow [this link.](https://docs.bbcscan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
