---
description: This tutorial will explain how to delegate/stake/unstake your BBC.
---

# Staking tutorial

Note: You can only stake BBC which is on Butane network. Please make sure you have changed into Butane network in Metamask while doing any transactions on staking UI. 

How to Stake Butane:

**Step 1:**

Navigate to staking.bbcscan.io and login to your wallet through metamask. Make sure you are on Butane network. If you are not please follow the instructions [**here**](https://docs.bbcscan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of BBC you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
