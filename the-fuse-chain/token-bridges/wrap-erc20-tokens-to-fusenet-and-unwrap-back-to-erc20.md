---
description: Steps to transfer/wrap BBR20 tokens from Ethereum to Fusenet
---

# Bridge for BBR20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Butane explorer to relay the tokens.
